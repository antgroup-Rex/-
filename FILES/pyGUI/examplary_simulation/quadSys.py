...
class quadSys:
    ...
    def setDimensionalParametrs(self,
                                k1 = 200.0,
                                L01 = 1.0,
                                mp = 1.0,
                                hp = 1,
        ...
        self.g       =   9.81        # [m/s^2]
        self.k1      =   k1       # [kg/m^3?] arbitrary given constant
        self.L01     =   L01         # [m]
        self.mp      =   mp         # [kg]
        self.hp      =   hp * self.L01             # [m]
        self.wp      =   wp * self.L01             # [m]
    ...
    def setInitialState(self):
        ...
        self.setHeaderStringForCSV()

    def setHeaderStringForCSV(self):
        self.headlineString = "Xp, XpVel, Yp, YpVel, Theta_p, Theta_pVel"

    def getHeaderStringForCSV(self):
        return self.headlineString
